...
export function isERC20(options: BaseTransactionOptions) {
  ...
  return allOf(
    isNameSupported(options.contract),
    isSymbolSupported(options.contract),
    isDecimalsSupported(options.contract),
    isTotalSupplySupported(options.contract),
    isBalanceOfSupported(options.contract),
    isTransferSupported(options.contract),
    isTransferFromSupported(options.contract),
    isApproveSupported(options.contract),
    isAllowanceSupported(options.contract),
  );
}
